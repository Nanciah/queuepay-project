...
import { Plus, Search, Edit, Trash2, Eye, Clock, Users, DollarSign } from 'lucide-react';
...
const Services = () => {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await companyAdmin.deleteService(id);
  ...
  return (
    <Layout title="Services">
      <div className="flex flex-wrap justify-between items-center mb-6">
        ...
        <Button variant="primary" onClick={() => navigate('/company-admin/services/create')}>
        ...
        {filteredServices.map((service) => (
          <Card key={service.id} hover>
            ...
            <div className="flex items-center gap-2 pt-4 border-t border-gray-100">
              <button
                onClick={() => navigate(`/company-admin/services/${service.id}`)}
              ...
              <button
                onClick={() => navigate(`/company-admin/services/${service.id}/edit`)}
      ...
      {filteredServices.length === 0 && (
        <Card className="text-center py-12">
          <div className="flex flex-col items-center">
            ...
            <p className="text-gray-500 mt-1">Créez votre premier service</p>
